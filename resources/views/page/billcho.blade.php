                    ...
                    @if(count($errors) >0)  
                       ...
                       @endif
                        ...
                        <a href="don-hang/{{Auth::user()->code}}"  class="col-2-type">Tất Cả</a>
                            <a href="cho-xac-nhan/{{Auth::user()->code}}" class="col-2-type-active">Chờ Xác Nhận</a>
                            <a href="cho-lay-hang/{{Auth::user()->code}}" class="col-2-type">Chờ Lấy Hàng</a>
                            <a href="da-giao/{{Auth::user()->code}}" class="col-2-type">Đã Giao</a>
                            ...
                            @foreach($orders as $od)
                                <div class="bill-list">
                                    ...
                                    <div class="total-pay">
                                        ...
                                        <a href="huy-don/{{$od->code}}" class="btn-huy-don-hang">
                                             <h4 class="huy-don-hang">Hủy Đơn Hàng</h4>
                                         </a>
